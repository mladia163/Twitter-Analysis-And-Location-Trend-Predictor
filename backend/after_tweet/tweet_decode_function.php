...
//$temp = tweet_decode("C:/xampp/htdocs/my/finalminor/backend/fetch_tweets_bounding_box/cli/json_data.txt");
//echo $temp;



function tweet_decode($path_to_data)
{
	...
	$text1 = "";
	$ans ="";
	$a=file_get_contents($path_to_data);
	$a=str_replace("'","",$a);
	//print_r($a);
	$ch=1;
	$st=0;
